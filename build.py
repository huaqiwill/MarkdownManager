...
from app.common.config import VERSION, YEAR, AUTHOR, COMPANY_NAME,PRODUCT_NAMNE
...
if sys.platform == "win32":
    args = [
        ...
        f'--product-name="{PRODUCT_NAMNE}"',
        f'--file-version={VERSION}',
        f'--product-version={VERSION}',
        f'--file-description="{PRODUCT_NAMNE}',
    ...
    args = [
        ...
        f'--macos-app-name="{PRODUCT_NAMNE}"',
